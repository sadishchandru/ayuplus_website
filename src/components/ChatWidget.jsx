  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-[80px] right-3 md:bottom-[132px] md:right-6 z-[999] w-[52px] h-[52px] md:w-14 md:h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe5d] hover:scale-105 transition-all duration-300 active:scale-95 flex items-center justify-center group"
      >

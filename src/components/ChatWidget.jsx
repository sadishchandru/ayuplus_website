  ...
  return (
    <>
      <div
        ...
        style={{ display: open ? "flex" : "none", right: "12px", bottom: "88px", width: "calc(100vw - 24px)", maxWidth: "384px", height: "min(520px, 75vh)" }}
      >
        <style>{`
          @media (min-width: 481px) {
            .chat-window { right: 24px !important; bottom: 144px !important; width: calc(100vw - 3rem) !important; }
          }
        `}</style>
          {/* Header */}
      ...
      <a
        ...
        className="fixed bottom-[68px] right-3 md:bottom-20 md:right-6 z-[999] w-[52px] h-[52px] md:w-14 md:h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe5d] hover:scale-105 transition-all duration-300 active:scale-95 flex items-center justify-center group"
      >

...
export default function ChatWidget() {
  ...
  return (
    <>
      <div
        className="fixed bottom-36 right-4 md:right-6 z-50 w-[calc(100vw-2rem)] max-w-sm bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden"
      ...
      <a
        ...
        className="fixed bottom-20 right-4 md:right-6 z-[999] w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe5d] hover:scale-105 transition-all duration-300 active:scale-95 flex items-center justify-center group"
      >

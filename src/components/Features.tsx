...
const FeatureBlock = ({ title, description, image, items, reverse, bgColor }: FeatureBlockProps) => (
    <div className={`w-full flex justify-center ${bgColor || 'bg-white'}`}>
        <div className={`container-1280 flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-8 md:gap-12 py-[40px] md:py-[70px]`}>
            <div className="flex-1 max-w-xl md:pr-13">
                <FadeIn delay={200}>
                        ...
                        {items.map((item, idx) => {
                            ...
                            return (
                                <li key={idx} className="flex items-start group">
                                    <div className="flex-shrink-0 w-[24px] h-[24px] rounded-full bg-[#00A63E] flex items-center justify-center mr-[12px] group-hover:bg-[#00A63E] transition-all border border-[#00A63E] mt-1">
        ...
        <section className="relative">
            <div className="w-full">
                    ...
                    items={[
                        {
                            ...
                            description: "Add new patients or retrieve existing records instantly"
                        },
                        {
                            title: "Real-time bed management",
                            description: "Track IPD admissions, bed availability, and ward occupancy"
                        },
                        {
                            title: "Complete patient history",
                            description: "Access all past visits, treatments, and medical records"
                        }
                    ]}
                />
                ...
                <FeatureBlock
                    ...
                    items={[
                        {
                            title: "Prakruti & Dosha tracking",
                            description: "Constitutional assessment and imbalance documentation"
                        },
                        {
                            title: "Panchakarma workflows",
                            description: "Complete procedure tracking for all traditional treatments"
                        },
                        {
                            title: "Tithi-based scheduling",
                            description: "Panchang integration for auspicious treatment timing"
                        }
                    ]}
                    reverse
                    bgColor="bg-[#FAFAFA]"
                    ...
                    items={[
                        {
                            ...
                            description: "Real-time tracking with low stock alerts"
                        },
                        {
                            title: "Billing integration",
                            description: "Automatic stock deduction and revenue tracking"
                        }
                    ]}
                />
            </div>

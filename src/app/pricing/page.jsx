...
export const metadata = {
  ...
  description: "Transparent pricing for every Ayurvedic hospital size. Starter ₹1,499/mo · Professional ₹3,999/mo · Advanced ₹5,999/mo · Enterprise ₹8,999/mo. On-premises or cloud. Setup + training included.",
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#fff", paddingTop: "80px" }}>
      ...
      <section style={{
        ...
        <p style={{ fontSize: "18px", color: "#bbf7d0", maxWidth: "600px", margin: "0 auto 28px", lineHeight: 1.6 }}>
          Choose the plan that fits your hospital. Upgrade or downgrade anytime. Setup and training included in every plan.
        </p>
        <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "16px 32px", color: "#86efac", fontSize: "14px", fontWeight: 500 }}>
      ...
      <section style={{ background: "#003d1a", padding: "80px 5%", textAlign: "center" }}>
        <h2 style={{ fontFamily: "'Hedvig Letters Serif', serif", fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 400, color: "#fff", marginBottom: "16px" }}>
          Start with a free 45-minute demo
        </h2>
